const questions = [
    {
      question: "1. რას სწავლობს ონომასტიკა?",
      answers: ["ა) გვარ-სახელთა სისტემას", " ბ) ტოპონიმიას – გეოგრაფიულ სახელებს;", "გ) თეონიმიას – ღმერთების, წმინდანების, ღვთაებების სახელებს", "დ) ყველა პასუხი სწორია. "],
      correctAnswers: [3], // Shkhara is the correct answer
      allowMultiple: false,
    },
    {
      question: "2. რომელ ბრუნვაშია ადგილის გარემოება [მესტია] შემდეგ   წინადადებებში?  სი ხიზგე მესტიას – შენ ცხოვრობ მესტიაში.  ეჯა იშვმნე მესტიას – ის ისვენებს მესტიაში. ",
      answers: ["ა) სახელობითში", "ბ) ვითარებითში ", "გ) მოქმედებითში", "დ) მიცემითში"],
      correctAnswers: [3], // Mestia-Ushguli Trek is the correct answer
      allowMultiple: false,
    },
    {
      question: "3.  ჩამოთვლილ ზედსართავ სახელთაგან რომელია ანტონიმები? ",
      answers: ["ა) მუჭხვი – მხიმ, ხოჩა – ხოლა, ჯდი – მეკვშდე, ტებდი – მცხი", "ბ) მუჭხვი, ტებდი, მცხი, მურგვლ, ტფხელ, ტაფშუ, მეგჭე ", "გ) ტებდი – მცხი, ტფხელ, ტაფშუ, მეგჭე, მურგვლ", "დ) ტებდი, მცხი, მურგვლ, ტფხელ, ტაფშუ, მეგჭე"],
      correctAnswers: [0], // Koshki is the correct answer
      allowMultiple: false,
    },
    {
      question: "4. ჩამოთვლილი ზმნური პარადიგმებიდან რომელია „ვლოცულობთ“ ზმნის ინკლუზიური ფორმა ?",
      answers: ["ა) მი ხვიმზირ – ეჯრ იმზირხ", "ბ) ნ ხვიმზირდ – სგ ხიმზირდ  ", "გ) ეჯრ იმზირხ – ეჯა იმზირ", "დ) მი ხვიმზირ – ნ ლიმზირდ "],
