const questions = [
    {
      question: "1. გრგლ, ყვარყვლ, ქვითრ, გვან, მამჭირ, ღირლ – ნაწარმოებ სახელთა რომელ ჯგუფს განეკუთვნება ჩამოთვლილი სახელები?  ",
    ...
    {
      question: "2.  დვით ლახვთე ესღრდა ჩჟშვ – რომელ ბრუნვაში დგას უბრალო დამატება [ჩჟშვ] ამ წინადადებაში?  ",
      answers: ["ა) მოთხრობითში", "ბ) სახელობითში ", "გ) მოქმედებითში ", "დ) ნათესაობითში"],
      correctAnswers: [1], // Mestia-Ushguli Trek is the correct answer
      allowMultiple: false,
    },
    {
      question: "3. ზმნური პარადიგმებიდან რომელი წყვილი არ გამოხატავს წარსულ დროს: ",
      answers: ["ა) მი ხვითვერდს – ნ ხვითვერდად ", "ბ) ნ ლითვერდად – სი ხითვერდს", "გ) ეჯრ ითვერდახ – ნ ხვითვერდად", "დ) ნ ხვითვერდად – ეჯა ითვერდა ", "ე) მი ხვითვრი – ნ ლითვრიდ"],
      correctAnswers: [4], // Koshki is the correct answer
      allowMultiple: false,
    },
    {
      question: "4..ჩამოთვლილი ზმნებიდან რომელია ინკლუზიური ფორმა?  ",
      answers: ["ა) სგ ჯაკფნხ – თქვენ გსურდათ ", " ბ) ნ ნაკფნ – ჩვენ გვსურდა ", "გ) ნ გვემდნ – ჩვენ შეგვეძლო", "დ) ნ ნემდნ – ჩვენ შეგვეძლო"],
