const questions = [
    {
      question: "1. ვინ ჩამოაყალიბა სვანეთში პირველი ფოლკლორული ანსამბლი?  ",
      answers: ["ა) ივანე მარგიანმა ", "ბ) მურზაყან დადეშქელიანმა", "გ) პლატონ დადვანმა ", "დ) ვახტანგ ფილფანმა "],
      correctAnswers: [0], // Shkhara is the correct answer
      allowMultiple: false,
    },
    {
      question: "2. რიცხვით სახელთა (ათეულების) რომელი თანმიმდევრობაა სწორი?",
      answers: ["ა)აშირ, ეშდ, უსგვშდ, სემეშდ, იშგვდშდ, ოხვშდშდ, ოშთხვეშდ, ერვეშდ, ჩხარშდ, არშდ,", "ბ)სემეშდ, ოშთხვეშდ, არშდ, ჩხარშდ, აშირ, ეშდ, ერვეშდ, უსგვშდ, იშგვდშდ, ოხვშდშდ ", "გ)არშდ, აშირ, ეშდ, უსგვშდ, იშგვდშდ, ოხვშდშდ, სემეშდ, ოშთხვეშდ, ერვეშდ, ჩხარშდ ", "დ) ეშდ, ერვეშდ, სემეშდ, ოშთხვეშდ, ოხვშდშდ, უსგვშდ, იშგვდშდ, არშდ, ჩხარშდ, აშირ "],
