const questions = [
    {
      question: "1. ტურისტლდ ადთრვეხ მთელ შვნ მურყვმლ – ამ წინადადებაში მრავლობით რიცხვში წარმოდგენილია არსებითი სახელი:  ",
      answers: ["ა) შვნ ", "  ბ) ტურისტლდ", "გ) ადთრვეხ", "დ) მურყვმლ"],
      correctAnswers: [3], // Shkhara is the correct answer
      allowMultiple: false,
    },
    {
      question: "2.  ვოშა/ოშა მეზგე იზგე ათხე ისგუ სოფელს? – წინადადებაში რომელია კითხვითი სიტყვა?  ",
      answers: [" ა) მეზგე ", "ბ) ათხე", "გ) ვოშა/ოშა ", "დ) ისგუ"],
      correctAnswers: [2], // Mestia-Ushguli Trek is the correct answer
      allowMultiple: false,
    },
    {
      question: "3. ზმნური პარადიგმებიდან რომელი ფორმა არ გამოხატავს წარსულ დროს? ",
      answers: ["ა) სგ ხიზგად – მი ხვიზგს", "ბ) ნ ხვიზგად – სი ხიზგს", "გ) ეჯა იზგე – ეჯრ იზგეხ ", "დ) ნ ლიზგად – ნ ხვიზგად"],
      correctAnswers: [2], // Koshki is the correct answer
      allowMultiple: false,
    },
    {
      question: "4. ლიდივ-ლიგზლ; ლისმაქ; ლიბოფშვ; ლიფუსდ; ლისვნ, ლივდულ – ჩამოთვლილ ფორმათაგან რომელი არის რთული სიტყვა ანუ კომპოზიტი? ",
      answers: ["ა) ლისმაქ, ლიბოფშვ", "ბ) ლისვნ", "გ) ლიფუსდ", "დ) ლიდივ-ლიგზლ"],
