const questions = [
  ...
  },
  {
      ...
      answers: [
      { text:  "ა)   კოლხური,  სვანური,  აფხაზური,  ხუნძური",   correct: false },
      { text:  "ბ) ქართული,  მეგრულ-ჭანური / ზანური,   სვანური",   correct: true},
      { text:  "გ) იბერიული,   ეტრუსკული,  ბასკური, ადიღური",   correct: false},
      { text:  "დ) სვანური,  პელაზგური,   ხეთური, ბასკური",     correct: false},
            ]
      },
      {
          question: "მესამე პირის  ნაცვალსახელებია: ",
          answers: [
          { text:  "ა) ეჯა – ეჯრ",   correct: true },
          { text:  "ბ) მი       –   ნ    ",   correct: false},
          { text:  "გ) ნ    –    სგ   ",   correct: false},
          { text:  "დ) სგ   –    სი",     correct: false},
             ]
          },
      ...
      
      {
          ...
          { text:  "გ) V  საუკუნეშიV  საუკუნეში  ",   correct: false},
          { text:  "დ) II საუკუნეში",     correct: false},
          { text:  "ე) ანტიკურ პერიოდში",     correct: true},
          ]
      },
    ...
    {
        question: "ბალსქვემოურ  დიალექტში  გვაქვს:  ",
        answers: [
        { text:  "ა)5    ხმოვანი",   correct: false },
        { text:  "ბ)     7    ხმოვანი",   correct: false},
        { text:  "გ)    12   ხმოვანი",   correct: false},
        { text:  "დ)   18   ხმოვანი",     correct: false},
        { text:  "ე)     9   ხმოვანი",     correct: true},
        ]
    },
    ...
    {
        question: "„ცხოვრობს“  ზმნის    მესამე პირის  ფორმაა:   ",
        answers: [
...

    {
        ...
        answers: [
        { text:  "ა)    მი  მეღვნი   ხვ   თეთრ    ",   correct: false },
    ...
    {
        question: "„ცხოვრობს“   ზმნის  მხოლობითი  და  მრავლობითი რიცხვის  პირველი  პირის  ფორმაა:   ",
        answers: [
        { text:  "ა)ხიზგე   –  ხიზგედ   ",   correct: false },
        { text:  "ბ)იზგე  –   ხვიზგედ    ",   correct: false},
        { text:  "გ)ხიზგედ – იზგეხ  ",   correct: false},
        { text:  "დ)ხიზგს   –  ხიზგუნი",     correct: false},
        { text:  "ე)ხვიზგე  – ლიზგედ",     correct: true},
        { text:  "ვ)იზგახ  –   ხვიზგად     ",     correct: false},
        ]
    },

    {
        ...
        { text:  "გ) 18   ხმოვანი",   correct: false},
        { text:  "დ)9    ხმოვანი",     correct: true},
        ]
    },

    {
        ...
        { text:  "ვ) ნ   ნალტ     –  სი  ჯალტ           ",     correct: false},
        ]
    },
...
// 17 kitxva
...

    {
        ...
        { text:  "ე) ე)    ნ     ნუღვა               –  ჩვენ  გვაქვს              ",     correct: false},
        { text:  "ვ) ვ)    ნ    ნირი                  –  ჩვენ  გვყავს       ",     correct: false},
    ...
    {
        question: "გეზლრ   ჯინრიხ-მა   ლაშდაბთე  ი  ჯიმურჯიხ-მა?  -მა  ნაწილაკი  ამ  წინადადებაში  გამოხატავს:      ",
        answers: [
...

    {
        ...
        { text:  "ბ)     იზგე  –    ხვიზგედ   ",   correct: false},
        { text:  "გ)    ხიზგედ  –  ხიზგე",   correct: false},
        { text:  "დ)    ხიზგს –  იზგა",     correct: true},
        { text:  "ე)     იზგე    –  იზგეხ  ",     correct: false},
        ]
    },

    {
        question: "„ლოცულობს“   ზმნის  პირველი  პირის  ფორმებია:  ",
        answers: [
...

    {
        ...
        { text:  "გ)  ვითარებითი",   correct: false},
        { text:  "დ) ნათესაობითში",     correct: false},
        { text:  "ე) მოქმედებითში  ",     correct: true},
        ]
    },
    ...
    {
        question: "ჰდშს ათხე იზგე  ჩხარა   მეზგე – ჰადიშში ახლა ცხოვრობს  ცხრა  ოჯახი.   ადგილის  გარემოება  დგას:  ",
        answers: [
        { text:  "ა)  მიცემითში ",   correct: true },
        { text:  "ბ)  ნათესაობითში   ",   correct: false},
        { text:  "გ)  ვითარებითში",   correct: false},
        { text:  "დ) სახელობითში",     correct: false},
        { text:  "ე) მოქმედებითში ",     correct: false},
        ]
    },
